...
Hint: use `.reduce` */
        ...
        function getCountryWins(array, initials) {
            ...
            // Next task: determine how many times "initials" wins in the countryMatches dataset.
            // I'm having trouble figuring out how to identify the team name as equal to the team initials,
            // in order to determine if the team won the world cup.
        };
...
the most goals scored per appearance (average goals for) in the World Cup finals */
